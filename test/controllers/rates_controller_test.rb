...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { constant: @rate.constant, creator_id: @rate.creator_id, value_bs: @rate.value_bs }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { constant: @rate.constant, creator_id: @rate.creator_id, value_bs: @rate.value_bs }
    assert_redirected_to rate_path(assigns(:rate))
  end
